...
const CalculatorApp = () => {
    ...
    const { formula, prevNumber, buildNumber, deleteLastDigit, toggleSign, clean, addOperation, subtractOperation, multiplyOperation, divideOperation, calculateResult, calculate } = useCalculator();
    ...
    return (
        <View style={ globalStyles.calcutorContainer }>
            ...
            <View style={ globalStyles.row }>
                ...
                <CalculatorBotton label="÷" color={Colors.orange} onPress={() => divideOperation()}/>
            </View>
            ...
            <View style={ globalStyles.row }>
                ...
                <CalculatorBotton label="X" color={Colors.orange} onPress={() => multiplyOperation()}/>
            </View>
            ...
            <View style={ globalStyles.row }>
                ...
                <CalculatorBotton label="-" color={Colors.orange} onPress={() => subtractOperation()}/>
            </View>
            ...
            <View style={ globalStyles.row }>
                ...
                <CalculatorBotton label="+" color={Colors.orange} onPress={() => addOperation()}/>
            </View>
            ...
            <View style={ globalStyles.row }>
                ...
                <CalculatorBotton label="=" color={Colors.orange} onPress={() => calculate()}/>
            </View>
        </View>
    )
}
